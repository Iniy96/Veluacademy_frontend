            ...
            <div id="carouselExampleCaptions" className="carousel slide" data-bs-ride="carousel" style={{height:"500px"}}>
                ...
                <div className="carousel-inner" >
                    <div className="carousel-item active" data-bs-interval="5000">
                        <img src={images.CarouselImaeg1} className="d-block w-100" alt="..."/>
                    ...
                    <div className="carousel-item" data-bs-interval="5000">
                        <img src={images.CarouselImaeg2} className="d-block w-100" alt="..."/>
                        <div className="overlay"></div> {/* Overlay div */}
                            <div className="carousel-caption d-none d-md-block">
                    ...
                    <div className="carousel-item" data-bs-interval="5000">
                        <img src={images.CarouselImaeg3} className="d-block w-100" alt="..."/>
                        <div className="overlay"></div> {/* Overlay div */}
                            <div className="carousel-caption d-none d-md-block">
